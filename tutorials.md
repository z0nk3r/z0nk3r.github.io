...
<main>
    ...
    <div class="terminal-empty">
        ...
        <p class="terminal-empty__hint">In the meantime: <a class="inline-link" href="{{ '/writeups/' | relative_url }}">writeups</a> &middot; <a class="inline-link" href="{{ '/references/' | relative_url }}">references</a>.</p>
    </div>
    {%- endif %}
